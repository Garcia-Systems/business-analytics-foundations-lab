...
Chapters 18–35 and the capstone are **planned**. Part III — Probability as a Model of Uncertainty has begun. The planned capstone will integrate business framing, data preparation, quantitative reasoning, computation, visualization, and communication in one coherent analytics challenge.
