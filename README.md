...
Chapter 19 develops paired observations, covariance, correlation, nonlinear dependence, and careful non-causal business interpretation:
...
Chapter 22 makes the statistic the object of study through repeated samples, standard error, sample-size comparisons, proportions, the Central Limit Theorem, and bias versus precision:
...
Chapter 24 evaluates a one-population mean claim with a transparent t statistic, tail probability, error simulations, power intuition, and business interpretation:
